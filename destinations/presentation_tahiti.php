    ...
    <div class="container">
        ...
        <div class="headbar">
         ...
         <div class="image_container">
    		<img class="presentation_img" src="../assets/tahiti_img.jpg" alt="tahiti image" />
    			<div class="description">
        			<h2>Découvrez la magie de Tahiti, un véritable paradis sur terre 🌴✨</h2>
        			<p>Plages de sable blanc, lagons aux eaux cristallines, couchers de soleil envoûtants... Tahiti vous invite à une escapade inoubliable au cœur du Pacifique.    
        			   Que vous soyez amateur de farniente, passionné de plongée ou en quête d'aventure, cette île enchanteresse saura combler toutes vos envies. 
        			   Explorez ses fonds marins spectaculaires, partez en randonnée à travers des paysages luxuriants et savourez la douceur de vivre polynésienne. 
        			   Laissez-vous séduire par l'accueil chaleureux des habitants et la richesse culturelle unique de Tahiti.
        			</p>
                    <br>
                    <b>Note CyLanta : 4.3 ⭐</b>
        		</div>
	</div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="Hôtel">
                                <option value="tahiti_blue_haven">Tahiti Blue Haven (4⭐)</option>
                                <option value="red_sunset_resort">Red Sunset Resort(4⭐)</option>
                                <option value="le_pacifique">Le Pacifique (5⭐)</option>
                            </select>
                        </td>
                        <td>
                            <select name="Pension">
